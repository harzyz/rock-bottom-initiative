  ...
  return (
    <div className="set bg-[#FAFAFA] flex flex-col min-h-[100vh]  w-full h-full">
      ...
      <div className="flex flex-col lg:flex-row h-full ">
        ...
        <div className="lg:w-[55%] px-[15px] py-[50px] flex justify-center">
          <form className="lg:w-[60%] gap-[20px] flex flex-col">
            <h1 className="font-bold text-[20px] lg:text-[36px] ">
              Volunteer Today!
            </h1>
            ...
            <div className="w-full flex-col lg:flex-row justify-between flex ">
              <div className="flex lg:w-[45%] gap-[10px] flex-col">
                ...
                <input
                  className="h-[50px] rounded-[8px] bg-[#F2F2F2]"
                  type="text"
                />
              </div>
              <div className="flex lg:w-[45%] gap-[10px] flex-col">
            ...
            <div className="w-full ">
              <div className="flex lg:w-[45%] gap-[10px] flex-col">
                <label className="text-[#9B9B9B] text-[18px]">
                  Email Address
                </label>
                <input
                  className="h-[50px] rounded-[8px] bg-[#F2F2F2]"
            ...
            <button className="lg:py-[16px] py-[8px] rounded-[5px] px-[16px] lg:px-[32px] bg-[#8B0000] text-[#fff]">
              Send a message
            </button>
          </form>
        </div>
