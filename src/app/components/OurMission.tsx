...
const OurMission = () => {
  ...
  return (
    <section className='w-full flex lg:flex-row flex-col gap-[50px] lg:items-end bg-[#8B0000] lg:px-[100px] lg:justify-between px-[15px] lg:py-[60px] py-[30px] '>
      {Missions.map((item)=> (
        <div key={item.id} className='lg:w-[45%] flex flex-col gap-[10px] text-[#fff]'>
        <h1 className='font-[500] uppercase text-[#fff] '>{item.title}</h1>
