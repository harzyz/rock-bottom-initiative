...
const ProvideAPlace = () => {
  return (
    <section className="w-full flex lg:flex-row flex-col gap-[50px] lg:items-center bg-[#FFF] lg:px-[100px] lg:justify-between px-[15px] lg:py-[60px] py-[30px]">
      <div className="lg:w-[50%] flex flex-col gap-[20px] items-start">
        <h1 className=" text-[30px] lg:text-[46px] lg:leading-[57px] font-[700]">
          Empowerment
        </h1>
      ...
      <div id="govid" className="lg:w-[40%] h-[500px] rounded-[20px]">
        <video className="w-full h-full rounded-[20px]" controls>
          <source
            src="https://res.cloudinary.com/dmvvb4t5w/video/upload/v1714502453/WhatsApp_Video_2024-04-30_at_7.31.23_PM_a1vok7.mp4"
            type="video/mp4"
          />
        </video>
      </div>
