...
import tola from '../assets/images/tolaMama.jpeg'
...
const OurGoal = () => {
  ...
  return (
    <section className="w-full h-full items-center lg:justify-between flex flex-col-reverse lg:flex-row bg-[#004832] px-[15px] py-[40px] lg:px-[100px] gap-[30px] lg:py-[60px] ">
      <div className="lg:w-[50%] flex flex-col gap-[20px] items-start">
        ...
        Motivated by her own struggles, Tola
          ...
          raise awareness and provide support to those in need. Tola&apos;s mission is
